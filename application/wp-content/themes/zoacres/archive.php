...
//Check CPT
if( is_tax( array( 'property-category', 'property-action', 'property-area', 'property-city', 'property-state', 'property-country' ) ) ){
	get_template_part( 'taxonomy', 'property-cpt' );
	return;
}elseif( is_post_type_archive( array( 'zoacres-property' ) ) ){
	get_template_part( 'zoacres-property', 'archive' );
	return;
}elseif( is_post_type_archive( array( 'zoacres-agent' ) ) ){
	get_template_part( 'zoacres-agent', 'archive' );
	return;
}
