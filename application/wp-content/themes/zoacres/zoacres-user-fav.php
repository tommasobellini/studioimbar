<?php
   /**
    *	Template Name: Agent/Agency Favorites
    */
					...
					<div class="user_tab_menu">
						<div class="user_dashboard_links">
							...
							<ul class="list-group">
								...
								<li class="list-group-item"><a href="<?php echo esc_url( $prop_fav_link ); ?>" class="d-block user_tab_active"><i class="fa fa-heart"></i><?php esc_html_e('Favorites', 'zoacres'); ?></a></li><!-- .agent-fav-property-list removed this class. This class used for ajax -->
					...
					<div class="zoacres-agent-panel">
						<div class="zoacres-user-details-wrap">
							...
							<?php 
								...
								$zpe::$cus_excerpt_len = apply_filters( 'zoacres_user_favorites_excerpt_length', $arch_exc_len );
