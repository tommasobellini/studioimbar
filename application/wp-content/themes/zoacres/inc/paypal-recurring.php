    ...
    * --------------------------------------------------------------------------------*/
    ...
    function setExpressCheckout() {
        ...
        if("SUCCESS" == strtoupper($httpParsedResponseAr["ACK"]) || "SUCCESSWITHWARNING" == strtoupper($httpParsedResponseAr["ACK"])) {
            ...
            echo esc_url( $payPalURL );
            exit;
        } else  {
            exit('SetExpressCheckout was failed: ' . print_r($httpParsedResponseAr, true));
        }
    }
    ...
    function fn_setExpressCheckout($methodName_, $nvpStr_) {
        ...
        $ch = function_exists('zoacres_curl_init') ? zoacres_curl_init() : ''; //curl_init();
        ...
        $httpResponse = function_exists('zoacres_curl_exec') ? zoacres_curl_exec( $ch ) : ''; //curl_exec($ch);
    ...
    * --------------------------------------------------------------------------------*/
    ...
    function createRecurringPaymentsProfile($token) {
        ...
        if("SUCCESS" == strtoupper($httpParsedResponseAr["ACK"]) || "SUCCESSWITHWARNING" == strtoupper($httpParsedResponseAr["ACK"])) {
            ...
            zoacres_update_user_recuring_profile( $profileID, $this->user_id );
            return true;
        } else  {
