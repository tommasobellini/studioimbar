...
class Homeo_Elementor_RealEstate_Properties extends Elementor\Widget_Base {
	...
	public function get_title() {
        return esc_html__( 'Apus Properties', 'homeo' );
    }
	...
	protected function _register_controls() {
        ...
        $this->add_control(
            'label_slugs',
            [
                'label' => esc_html__( 'Labels Slug', 'homeo' ),
                'type' => Elementor\Controls_Manager::TEXTAREA,
                'rows' => 2,
                'default' => '',
                'placeholder' => esc_html__( 'Enter slugs spearate by comma(,)', 'homeo' ),
	...
	protected function render() {
        ...
        if ( $loop->have_posts() ) {
            ...
            ?>
            <div class="widget-properties <?php echo esc_attr($layout_type.' item-'.$property_item_style); ?> <?php echo esc_attr($el_class); ?>">
...
Elementor\Plugin::instance()->widgets_manager->register_widget_type( new Homeo_Elementor_RealEstate_Properties );