	...
	function homeo_custom_styles() {
		...
		?>
			...
			<?php if ( homeo_get_config('main_color') != "" ) : ?>
				...
				.bg-theme, .property-item .top-label > *.featured-property, .details-product .apus-social-share a:hover, .details-product .apus-social-share a:active, .slick-carousel .slick-arrow:hover, .slick-carousel .slick-arrow:focus, .mobile-sidebar-btn, .btn-show-filter, .btn-show-filter i, .btn-show-filter:hover, .btn-show-filter:focus
				{
				...
				a:focus,a:hover, .mm-menu .mm-listview > li.active > a, .mm-menu .mm-listview > li > a:hover, .mm-menu .mm-listview > li > a:focus, .property-grid-slider .property-price, .mm-menu .menu a:hover, .mm-menu .menu a:focus, .menu-item.current_page_item a , .type-banner-property.style3 .icon, .megamenu .dropdown-menu li:hover > a, .megamenu .dropdown-menu li.current-menu-item > a, .megamenu .dropdown-menu li.open > a, .megamenu .dropdown-menu li.active > a, .featured-property, .top-detail-member .agency-socials a:hover, .top-detail-member .agency-socials a:focus, .elementor-accordion .elementor-tab-title.elementor-active a, .widget-search .btn:hover, .widget-search .btn:focus, .list-options-action [type="radio"]:checked + label, .megamenu > li:hover > a, .megamenu > li.active > a, .properties-currencies .currencies li.active label, .properties-currencies .currencies li label:hover, .form-group-price.list ul.price-filter li:hover, .ajax-pagination .apus-loadmore-btn.hidden + .apus-allproducts, .select2-container.select2-container--default .select2-results__option[aria-selected="true"]::before, .select2-container--default .select2-results__option[data-selected="true"]::before
				{
