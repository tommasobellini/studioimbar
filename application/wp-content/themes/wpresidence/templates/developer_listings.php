...
$term_bar='<div class="term_bar_item active_term" data-term_id="0" data-term_name="all">'.__('All','wpestate').' ('.$prop_selection->found_posts.')</div>';
    ...
    while ($prop_selection->have_posts()): $prop_selection->the_post();      
        ...
        if(key_exists ($property_category[0]->slug,$terms) ){
            $terms[ $property_category[0]->slug ][0]=$terms[ $property_category[0]->slug ][0]+1;
        }else{
            $terms[ $property_category[0]->slug ] = array(1,$property_category[0]->name,$property_category[0]->term_id);
        }
