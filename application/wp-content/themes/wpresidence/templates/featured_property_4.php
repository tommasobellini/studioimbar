...
$return_string.= '
    <div class="featured_property featured_property_type4">
            ...
            $return_string.='<div class="property_featured_details">';
                $return_string.='<a href="'.esc_url($link).'" class="unit_details_x">'.__('full info','wpestate').'</a>';
                $return_string.='<a href="#" class="unit_map_featured">'._('map','wpestate').'</a>';
            $return_string.='</div>';
           ...
           $return_string.='
                ...
                <div class="share_unit">
                    <a href="'.$protocol.'://www.facebook.com/sharer.php?u='. esc_url($link).'&amp;t='.urlencode(get_the_title()).'" target="_blank" class="social_facebook"></a>
                    <a href="'.$protocol.'://twitter.com/home?status='.urlencode(get_the_title().' '.$link).'" class="social_tweet" target="_blank"></a>
