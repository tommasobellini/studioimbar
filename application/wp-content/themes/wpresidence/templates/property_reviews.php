<div class="property_reviews_wrapper">
    ...
    <h3><?php _e('Property Reviews ','wpestate');?></h3>
...
?>
    ...
    if ( is_user_logged_in() ) {   
        ...
        <h5><?php    
            if( $user_posted_coment!=0 ){
                print '<div class="review_tag">'._('Update Review ','wpestate');
                if(wp_get_comment_status($user_posted_coment)=='unapproved'){
                   print ' - '. __('pending approval','wpestate');
                }
                print '</div>';                
            }else{
                print '<div class="review_tag">'._('Write a Review ','wpestate').'</div>';
            }
            ?>
        </h5>
        <div class="add_review_wrapper">
            ...
            <textarea rows="8" id="wpestare_review_content" name="wpestare_review_content" class="form-control"><?php 
                if( $user_posted_coment!=0  ){
                    echo $comment_content;
                }else{
                    _e('Your Review','wpestate');
                }
                ?></textarea>
            <?php 
    ...
    ?>
        <h5 class="review_notice"><?php _e('You need to login in order to post a review ','wpestate');?></h5>
    <?php
    }
    ?>
