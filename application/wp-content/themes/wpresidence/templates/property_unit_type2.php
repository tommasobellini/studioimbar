...
<div class="<?php echo esc_html($col_class);?> listing_wrapper property_unit_type2" data-org="<?php echo esc_html($col_org);?>" data-listid="<?php echo intval($post->ID);?>" > 
    <div class="property_listing property_unit_type2 <?php if($wpestate_uset_unit==1) print 'property_listing_custom_design' ?> " data-link="<?php   if(  $property_unit_slider==0){ echo esc_url($link);}?>">
        ...
        <?php if ($wpestate_uset_unit==1){
         ...
         wpestate_build_unit_custom_structure($custom_unit_structure,$post->ID,$property_unit_slider);
            ...
            <div class="property_listing_details">
                <?php 
                    if($property_rooms!=''){
                        print ' <span class="inforoom_unit_type2">'.$property_rooms.'</span>';
                    }

                    if($property_bathrooms!=''){
                        print '<span class="infobath_unit_type2">'.$property_bathrooms.'</span>';
                    }
                    if ($garage_no != '') {
                        print ' <span class="infogarage_unit_type2">' . $garage_no . '</span>';
                    }
                    if($property_size!=''){
                        print ' <span class="infosize_unit_type2">'.$property_size.' '.$measure_sys.'<sup>2</sup></span>';
                    }
