...
jQuery(document).ready(function(){
    ...
    jQuery('#directory_load_more').click(function(event){
    ...
    jQuery("#slider_property_size_widget").slider({
        ...
        slide: function (event, ui) {
            ...
            jQuery("#property_size").text(  ui.values[0] +directory_vars.measures_sys+ " "+control_vars.to+" " + ui.values[1]+directory_vars.measures_sys );
            wpestate_directory_filtering();
        }
    });
    ...
    jQuery("#slider_property_lot_size_widget").slider({
        ...
        slide: function (event, ui) {
            ...
            jQuery("#property_lot_size").text(  ui.values[0]+directory_vars.measures_sys+ " "+control_vars.to+" " + ui.values[1] + directory_vars.measures_sys);
            wpestate_directory_filtering();
        }
    });
...
//    
    ...
    jQuery('.extended_search_check_wrapper_directory input[type="checkbox"]').click(function () {
        wpestate_directory_filtering();
    });


    jQuery('.listing_filters_head_directory li').click(function () {
    ...
    jQuery('.directory_sidebar  li').click(function () {
        wpestate_directory_filtering();
    });

    jQuery('#property_status,#property_keyword').change(function(){
        wpestate_directory_filtering();
    });
