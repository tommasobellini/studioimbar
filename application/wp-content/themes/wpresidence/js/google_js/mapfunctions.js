...
function get_custom_value_onthelist(slug){
 ...
 function wpestate_show_pins() {
   ...
   // console.log (googlecode_regular_vars.is_half_map_list+ " mapfunctions_vars.adv_search_typexxx "+mapfunctions_vars.adv_search_type);
   ...
   // console.log ("parseInt(mapfunctions_vars.is_half "+parseInt(mapfunctions_vars.is_half) );
 ...
 function wpestate_show_pins_custom_search(){
   ...
   console.log('wpestate_show_pins_custom_search');
    ...
    //console.log("mapfunctions_vars.is_half "+mapfunctions_vars.is_half);
    if ( parseInt(mapfunctions_vars.is_half)===1 ){
        if(first_time_wpestate_show_inpage_ajax_half===0){
            first_time_wpestate_show_inpage_ajax_half=1
        }else{
