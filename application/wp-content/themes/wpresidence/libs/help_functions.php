...
if( !function_exists('get_dasboard_add_agent') ):
    function get_dasboard_add_agent(){
        $pages = get_pages(array(
            'meta_key' => '_wp_page_template',
            'meta_value' => 'user_dashboard_add_agent.php'
        ));
...
if( !function_exists('get_dashboard_inbox') ):
    function get_dashboard_inbox(){
        $pages = get_pages(array(
            'meta_key' => '_wp_page_template',
...
if( !function_exists('get_dasboard_agent_list') ):
    function get_dasboard_agent_list(){
        $pages = get_pages(array(
            'meta_key' => '_wp_page_template',
            'meta_value' => 'user_dashboard_agent_list.php'
        ));
...
if( !function_exists('get_dasboard_showing') ):
    function get_dasboard_showing(){
        $pages = get_pages(array(
            'meta_key' => '_wp_page_template',
            'meta_value' => 'user_dashboard_showing.php'
        ));
