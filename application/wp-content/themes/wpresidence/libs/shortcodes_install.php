    ...
    if( !function_exists('wpestate_vc_shortcodes')):
                ...
                array(
                    ...
                    "params" => array(
                        ...
                        array(
                            ...
                            "holder"        =>  "div",
                            "class"         =>  "",
                            "heading"       =>  __("Virtual Tour","wpestate"),
                            "param_name"    =>  "virtual_tour",
                            "value"         =>  __("Virtual Tour","wpestate"),
                            "description"   =>  __("Virtual Tour in the tab. Set it blank if you don't want it to appear.","wpestate")
                        ),
                        ...
                        array(
                            ...
                            "holder"        =>  "div",
                            "class"         =>  "",
                            "heading"       =>  __("Yelp Details","wpestate"),
                            "param_name"    =>  "yelp_details",
                            "value"         =>  __("Yelp Views","wpestate"),
                            "description"   =>  __("Yelp Views in the tab. Set it blank if you don't want it to appear.","wpestate")
                        ),
        ...
        vc_map(
            array(
             ...
             vc_map( array(
                "name" => esc_html__( "Display Categories","wpestate"),//done
                "base" => "places_list",
                "class" => "",
                ...
                'weight'=>100,
                'icon'   =>'wpestate_vc_logo',
                'description'=>esc_html__( 'Display Categories','wpestate'),  
                "params" => array(
                    array(
                        "type" => "textfield",
                        "holder" => "div",
                        "class" => "",
                        "heading" => esc_html__( "Category(Categories,Actions,Cities,Areas or Neighborhood) IDs, separated by comma","wpestate"),
                        "param_name" => "place_list",
                        "value" => "",
                        "description" => esc_html__( "Category (Categories,Actions,Cities,Areas or Neighborhood) IDs, separated by comma","wpestate")
                    )  ,
                    array(
                        "type" => "textfield",
                        "holder" => "div",
                        "class" => "",
                        "heading" => esc_html__( "Items per row","wpestate"),
                        "param_name" => "place_per_row",
                        "value" => "4",
                        "description" => esc_html__( "How many items listed per row? For type 2 use only 1.","wpestate")
                    ),
                    array(
                        "type" => "dropdown",
                        "holder" => "div",
                        ...
                        "description" => esc_html__( "Select Item Type 1/2?","wpestate")
                    ),
            ...
            array(
                ...
                "params" => array(
                    ...
                    array(
                       ...
                       "holder" => "div",
                       "class" => "",
                       "heading" => __("County/State Id's","wpestate"),
                       "param_name" => "state_ids",
                       "value" => "",
                       "description" => __("list of county/State ids separated by comma (*only for properties)","wpestate")
                    ),
                    array(
                       "type" => "textfield",
                       "holder" => "div",
                    ...
                    array(
                       ...
                       "description" => __("Auto scroll period in seconds - 0 for manual scroll, 1000 for 1 second, 2000 for 2 seconds and so on.","wpestate")
                        ...
                        "holder" => "div",
                        "class" => "",
                        "heading" => __("Show Featured Listings First (yes/no)","wpestate"),
                        "param_name" => "featured_first",
                        "value" => $random_pick,
                        "description" => __("If 'yes'  featured properties will be displayed first, and the rest by ID(adding date).If 'no' all will be order by  ID(adding date) ","wpestate")
                  ) 
            ...
            $featured_pack_sh=array('no','yes');
              vc_map(
                   array(
                   "name" => __("Membership Package","wpestate"),
                   ...
                   'weight'=>102,
                   'icon'   =>'wpestate_vc_logo',
                   'description'=>__('Membership Package','wpestate'),
                   "params" => array(
                       array(
                            "type" => "textfield",
                            "holder" => "div",
                            "class" => "",
                            "heading" => __("Package id","wpestate"),
                            "param_name" => 'package_id',
                            "value" => "",
                            "description" => __("Package id","wpestate")
                           ),
                        array(
                            "type" => "textfield",
                            "holder" => "div",
                            "class" => "",
                            "heading" => __("Content of the package box","wpestate"),
                            "param_name" => "package_content",
                            "value" => "",
                            "description" => __("Add content for the package","wpestate")
                       ),
                       array(
                            "type" => "dropdown",
                            "holder" => "div",
                            "class" => "",
                            "heading" => __("Make package featured","wpestate"),
                            "param_name" => "pack_featured_sh",
                            "value" => $featured_pack_sh,
                            "description" => __("Make package featured (no/yes)","wpestate")
                        ),
                   )
                )   
            );
                    vc_map(
                    array(
                    "name" => __("Featured Agency / Developer shortcode","wpestate"),
                    ...
                    'weight'=>102,
                    'icon'   =>'wpestate_vc_logo',
                    'description'=>__('Featured Developer / Agency','wpestate'),
                    "params" => array(
                        array(
                            "type" => "textfield",
                            "holder" => "div",
                            "class" => "",
                            "heading" => __("Agency or Developer post ID","wpestate"),
                            "param_name" => 'user_role_id',
                            "value" => "",
                            "description" => __("Copy the ID from Agency or Developer list","wpestate")
                       ),
                        array(
                            "type" => "textfield",
                            "holder" => "div",
                            "class" => "",
                            "heading" => __("Status Text Label","wpestate"),
                            "param_name" => "status",
                            "value" => "",
                            "description" => __("Status Text Label","wpestate")
                        ),
                        array(
                            "type" => "textfield",
                            "holder" => "div",
                            ...
                            "value" => "",
                            "description" => __("Path to an image of your choice (best size 300px  x 300px) ","wpestate")
                        ), 
                    )
                )   
            );
                ...
                array(
                    ...
                    'params'            =>  array(
                        ...
                        array(
                            ...
                            "holder" => "div",
                            "class" => "",
                            "heading" => __("Testimonial Type","wpestate"),
                            "param_name" => "testimonial_type",
                            "value" => $testimonials_type,
                            "description" => __("Select 1,2,3","wpestate")
                        ), array(
                            "type" => "textfield",
                            "holder" => "div",
                            "class" => "",
                            "heading" => __("Stars","wpestate"),
                            "param_name" => "stars_client",
                            "value" => "5",
                            "description" => __("Only for type3: no of stars for reviews (from 1 to 5, increment by 0.5) ","wpestate")
                        ), array(
                            "type" => "textfield",
                            "holder" => "div",
                            "class" => "",
                            ...
                            "value" => "Great House",
                            "description" => __("Only for type3:Testimonial Title ","wpestate")
                        ),
                    )
                )   
            );
               ...
               "params" => array(
                  ...
                  array(
                    ...
                    array(
                     ...
                     "holder" => "div",
                     "class" => "",
                     "heading" => __("List of terms id for the filter bar (*applies only for properties, not articles/posts)","wpestate"),
                     "param_name" => "control_terms_id",
                     "value" => "",
                     "description" => __("Terms are items in any property taxonomy(Category, Action, City, Area or State/County)","wpestate")
                  ),
                   array(
                     "type" => "textfield",
                     "holder" => "div",
                  ...
                  array(
                   ...
                   array(
                    ...
                    array(
                     ...
                     "holder" => "div",
                     "class" => "",
                     "heading" => __("Design Type","wpestate"),
                     "param_name" => "design_type",
                     "value" =>  $featured_prop_type,
                     "description" => __("type 1, 2 or 3","wpestate")
                  )    
               )
            )
            );
            ...
            vc_map(
               ...
               'weight'=>100,
               'icon'   =>'wpestate_vc_logo',
               'description'=>__('Contact Form Shortcode','wpestate'),     
               "params" => array(
                   array(
                     "type" => "dropdown",
                     "holder" => "div",
                     "class" => "",
                     "heading" => __("Text Align","wpestate"),
            ...
            vc_map(
                array(
                "name" => __("Testimonial Slider","wpestate"),
                ...
                'weight'=>100,
                'icon'   =>'wpestate_vc_logo',
                'description'=>__('Testimonial Slider','wpestate'),     
                "params" => array(
                    array(
                        "type" => "textfield",
                        "holder" => "div",
                        ...
                        "holder" => "div",
                        "class" => "",
                        "heading" => __("Visible Items","wpestate"),
                        "param_name" => "visible_items",
                        "value" => "1",
                        "description" => __("How many items are visible","wpestate")
                    )
                    , array(
                        "type"          =>  "dropdown",
                        "holder"        =>  "div",
                        ...
                        "value"         =>  $testimonials_type,
                        "description"   =>  __("What type of slider do you use?","wpestate")
                    ),
