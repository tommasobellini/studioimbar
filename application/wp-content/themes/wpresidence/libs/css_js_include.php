...
function wpestate_scripts() {   
    ...
    if ( is_page_template('user_dashboard_add_agent.php') || is_page_template('user_dashboard_add.php') || is_page_template('user_dashboard_profile.php') ){
        wp_enqueue_script("jquery-ui-draggable");
   ...
   $measure_sys             = get_option('wp_estate_measure_sys','');
    ...
    if( ( is_tax('property_category') || is_tax('property_action_category') || is_tax('property_city') || is_tax('property_area') || is_tax('property_county_state')  ) &&  $property_list_type_tax == 2  ){
    ...
    if(is_page_template('user_dashboard_add.php') || is_page_template('user-dashboard.php') || is_page_template('user_dashboard_profile.php') ){
            $page_lat   = '';
            $page_long  = '';
    ...
    wp_localize_script('control', 'control_vars', 
      ...
      wp_localize_script('ajaxcalls', 'ajaxcalls_vars', 
            array(  'contact_name'          =>  __('Your Name','wpestate'),
                    ...
                    'agent_list'            =>  get_dasboard_agent_list(),
                )
     );
    ...
    if( is_page_template('property_list_directory.php') ){
        ...
        wp_localize_script('directory', 'directory_vars', 
            array(   
                'dir_min_size'          =>  get_post_meta($post->ID,'dir_min_size',true),
                'dir_max_size'          =>  get_post_meta($post->ID,'dir_max_size',true),
                'dir_min_lot_size'      =>  get_post_meta($post->ID,'dir_min_lot_size',true),
                'dir_max_lot_size'      =>  get_post_meta($post->ID,'dir_max_lot_size',true),
                ...
                'dir_bedrooms_max'      =>  get_post_meta($post->ID,'dir_bedrooms_max',true),
                'measures_sys'          =>  get_option('wp_estate_measure_sys',''),
    ...
    if( is_page_template('user_dashboard_profile.php') || is_page_template('user_dashboard_add.php')  || is_page_template('user_dashboard_add_agent.php')  ){
        $is_profile=0;
