...
function estate_sidebar_meta() {
    ...
    add_meta_box('wpestate-header',             esc_html__('Title & Stars'), 'wpestate_comment_starts', 'comment', 'normal');
}
...
if(!function_exists('estate_prpg_design_option')):
    function estate_prpg_design_option(){
        ...
        if(   'estate_property' == get_post_type() ){
            ...
            // slider type
            $slider_type                    =   array('global','vertical','horizontal','full width header','gallery','multi image slider');
