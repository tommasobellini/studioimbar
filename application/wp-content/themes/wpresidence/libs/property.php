...
add_action( 'property_action_category_add_form_fields',    'wpestate_property_city_callback_add_function', 10, 2 );  
...
add_action( 'property_county_state_edit_form_fields',   'wpestate_property_city_callback_function', 10, 2);
add_action( 'property_county_state_add_form_fields',    'wpestate_property_city_callback_add_function', 10, 2 );  
    ...
    $items .= '<div class="item ">
            ...
            <div class="carousel-caption">';
                ...
                if($caption!=''){
                    ...
                    <div class="carousel_caption_text">'.get_the_excerpt($post_thumbnail_id).'</div>';
                }
    $items .= '       
            </div>
        </div>';   
