...
function wpestate_downgrade_to_pack( $user_id, $pack_id ){
    ...
    $agent_list     =   get_user_meta($user_id,'current_agent_list',true);
    $agent_list[]   =   $user_id;
...
function wpestate_get_user_curent_listings_published($userid) {
    $agent_list     =   get_user_meta($userid,'current_agent_list',true);
    $agent_list[]   =   $userid;
...
function  wpestate_ajax_make_prop_featured(){
    ...
    $agent_list                     =   get_user_meta($parent_userID,'current_agent_list',true);
