    ...
    <div id="wpestate_sidebar_menu">
        <div id="general_settings_sidebar" class="theme_options_sidebar">
            <ul>
                ...
                <li data-optiontab="property_rewrite_page_tab" class="">'.__('Edit Property, Agent, Agency and Developer text links','wpestate').'</li>
        ...
        <div id="advanced_search_settings_sidebar" class="theme_options_sidebar" style="display:none;">
            <ul>
                ...
                <li data-optiontab="geo_location_search_tab" class="">'.__('Geo Location Search','wpestate').'</li>
            </ul>
        </div>
    ...
    print ' <div id="wpestate_wrapper_admin_menu"> 
                ...
                <div id="advanced_search_settings_sidebar_tab" class="theme_options_wrapper_tab"  style="display:none">
                        ...
                        <div id="geo_location_search_tab" class="theme_options_tab" style="display:none;">
                            <h1>'.__('Geo Location Search','wpestate').'</h1>
                            <input type="submit" name="submit"  class="new_admin_submit new_admin_submit_right" value="'.__('Save Changes','wpestate').'" />
                            <div class="theme_option_separator"></div>';
...
function new_wpestate_theme_admin_general_settings(){
    ...
    $visible_user_role_select      =  array( __('User','wpestate') ,__('Agent','wpestate'),__('Agency','wpestate'),__('Developer','wpestate'));
    ...
    print'<div class="estate_option_row">
        <div class="label_option_row">'.__('Display user roles dropdown in register forms','wpestate').'</div>
        <div class="option_row_explain">'.__('This applies for for all register forms.','wpestate').'</div>    
    ...
    $submission_user_role_select    =   array( __('User','wpestate') ,__('Single Agent','wpestate'),__('Agency','wpestate'),__('Developer','wpestate'));
    
    $visible_user_role     =    get_option('wp_estate_visible_user_role','');

    print'<div class="estate_option_row">
    <div class="label_option_row">'.__('Select user roles to display in register forms','wpestate').'</div>
    <div class="option_row_explain">'.__('This applies for all register forms. *Hold CTRL for multiple selection.','wpestate').'</div>    
    ...
    print'<div class="estate_option_row">
        <div class="label_option_row">'.__('Admin Should approve the reviews','wpestate').'</div>
        <div class="option_row_explain">'.__('If yes, the reviews can be found in comments section','wpestate').'</div>    
...
function new_wpestate_header_settings(){
    ...
    print'<div class="estate_option_row">
    <div class="label_option_row">'.__('Header 5 - Info widget1 - icon ','wpestate').'</div>
    <div class="option_row_explain">'.__('Header 5 - Info widget1 - icon. Ex: fa fa-phone ','wpestate').'</div>    
    ...
    print'<div class="estate_option_row">
    <div class="label_option_row">'.__('Header 5 - Info widget2 - First line of text ','wpestate').'</div>
    <div class="option_row_explain">'.__('Header 5 - Info widget2 - First line of text','wpestate').'</div>    
    ...
    print'<div class="estate_option_row">
    <div class="label_option_row">'.__('Header 5 - Info widget2 - Second line of text ','wpestate').'</div>
    <div class="option_row_explain">'.__('Header 5 - Info widget1 - Second line of text','wpestate').'</div>    
    ...
    print'<div class="estate_option_row">
    <div class="label_option_row">'.__('Header 5 - Info widget2 - icon ','wpestate').'</div>
    <div class="option_row_explain">'.__('Header 5 - Info widget2 - icon.  Ex: fa fa-phone','wpestate').'</div>    
    ...
    print'<div class="estate_option_row">
    <div class="label_option_row">'.__('Header 5 - Info widget 1 - First line of text ','wpestate').'</div>
    <div class="option_row_explain">'.__('Header 5 - Info widget 1 - First line of text','wpestate').'</div>    
    ...
    print'<div class="estate_option_row">
    <div class="label_option_row">'.__('Header 5 - Info widget 2 - Second line of text ','wpestate').'</div>
    <div class="option_row_explain">'.__('Header 5 - Info widget 2  - Second line of text','wpestate').'</div>    
    ...
    print'<div class="estate_option_row">
    <div class="label_option_row">'.__('Header 5 - Info widget 3 - icon ','wpestate').'</div>
    <div class="option_row_explain">'.__('Header 5 - Info widget 3 - icon. Ex: fa fa-phone','wpestate').'</div>    
    ...
    print'<div class="estate_option_row">
    <div class="label_option_row">'.__('Header 5 - Info widget 3 - First line of text ','wpestate').'</div>
    <div class="option_row_explain">'.__('Header 5 - Info widget 3 - First line of text','wpestate').'</div>    
    ...
    print'<div class="estate_option_row">
    <div class="label_option_row">'.__('Header 5 - Info widget 3 - Second line of text ','wpestate').'</div>
    <div class="option_row_explain">'.__('Header 5 - Info widget 3 - Second line of text','wpestate').'</div>    
...
function new_wpestate_footer_settings(){
    ...
    print'<div class="estate_option_row">
    <div class="label_option_row">'.__('Use Sticky Footer? ','wpestate').'</div>
    <div class="option_row_explain">'.__('Use Sticky Footer?','wpestate').'</div>    
...
function new_wpestate_appeareance(){
    ...
    <div class="option_row_explain">'.__('The maximum no of images an user can upload on front end. Use 0 for unlimited. This value will not be used in case of  membership mode.(each package will have it\'s own max image no)','wpestate').'</div>    
...
function new_wpestate_property_page_details(){
    ...
    print'<div class="estate_option_row">
    <div class="label_option_row">'.__('Show Reviews on Property Page','wpestate').'</div>
    <div class="option_row_explain">'.__('Show Reviews on Property Page.','wpestate').'</div>    
    ...
    print'<div class="estate_option_row">
    <div class="label_option_row">'.__('Enable Direct Message','wpestate').'</div>
    <div class="option_row_explain">'.__('If set to no you will need to delete Inbox page template.','wpestate').'</div>    
...
function new_wpestate_map_details(){
    ...
    print'<div class="estate_option_row">
    <div class="label_option_row">'.__('Force Google Map at the full screen size ? ','wpestate').'</div>
    <div class="option_row_explain">'.__('Applies for header google maps when set as global header media type, except property page.','wpestate').'</div>    
...
function new_wpestate_membership_settings(){
    ...
    $submission_user_role_select    =   array(__('Agent','wpestate'),__('Agency','wpestate'),__('Developer','wpestate'));
    
    $admin_submission_user_role     =    get_option('wp_estate_admin_submission_user_role','');

    print'<div class="estate_option_row">
    <div class="label_option_row">'.__('Select wich user role the admin should approve?','wpestate').'</div>
    <div class="option_row_explain">'.__('Users will be automatically approved. *Hold CTRL for multiple selection.','wpestate').'</div>    
...
//    </div>';
    ...
    print'<div class="estate_option_row">
    <div class="label_option_row">'.__('Free Membership Images - no of images per listing ','wpestate').'</div>
    <div class="option_row_explain">'.__('Option applies for each free published listing.','wpestate').'</div>    
...
function new_wpestate_pin_management(){  
    ...
    print'<div class="estate_option_row">
    <div class="label_option_row">'.__('Use single Image Pin ?','wpestate').'</div>
    <div class="option_row_explain">'.__('We will use 1 single pins for all markers. This option will decrease the loading time on you maps.','wpestate').'</div>    
...
if( !function_exists('wpestate_geo_location_tab') ):   
    function    wpestate_geo_location_tab(){
        ...
        print'<div class="estate_option_row">
        <div class="label_option_row">'.__('Use Geo Location Search','wpestate').'</div>
        <div class="option_row_explain">'.__('If yes, the geo location search will appear above half map search fields','wpestate').'</div>    
        ...
        print'<div class="estate_option_row">
        <div class="label_option_row">'.__('Initial area radius ','wpestate').'</div>
        <div class="option_row_explain">'.__('Initial area radius ','wpestate').'</div>    
        ...
        print'<div class="estate_option_row">
        <div class="label_option_row">'.__('Minimum radius vale','wpestate').'</div>
        <div class="option_row_explain">'.__('Minimum radius value','wpestate').'</div>    
        ...
        print'<div class="estate_option_row">
        <div class="label_option_row">'.__('Maximum radius value','wpestate').'</div>
        <div class="option_row_explain">'.__('Maximum radius value','wpestate').'</div>    
            <input  type="text" id="max_geo_radius"  name="max_geo_radius"   value="'.$max_geo_radius.'" size="40"/>
        </div>';
        
        
        $value_array_geo=array( __('miles','wpestate'),__('km','wpestate') );
...
function    new_wpestate_advanced_search_form(){
    ...
    print'<div class="estate_option_row">
    <div class="label_option_row">'.__('Put Search form before the header media ?','wpestate').'</div>
    <div class="option_row_explain">'.__('Works with "Use FLoat Form" options set to no ! Is not working with search type 3','wpestate').'</div>    
    ...
    print'<div class="estate_option_row">
    <div class="label_option_row">'.__('Use sticky search ?','wpestate').'</div>
    <div class="option_row_explain">'.__('This will replace the sticky header. Is not working for type 3.','wpestate').'</div>    
    ...
    print'<div class="estate_option_row">
    <div class="label_option_row">'.__('Use Float Search Form ?','wpestate').'</div>
    <div class="option_row_explain">'.__('The search form is "floating" over the media header and you are setting up the position','wpestate').'</div>    
    ...
    print'<div class="estate_option_row">
    <div class="label_option_row">'.__('Distance betwen search form and the top margin of the browser: Ex 200px or 20%','wpestate').'</div>
    <div class="option_row_explain">'.__('Distance betwen search form and the top margin of the browser: Ex 200px or 20%.','wpestate').'</div>    
    ...
    print'<div class="estate_option_row">
    <div class="label_option_row">'.__('Distance betwen search form and the top margin of the browser in px Ex 200px or 20% - for taxonomy, category and archives pages','wpestate').'</div>
    <div class="option_row_explain">'.__('Distance betwen search form and the top margin of the browser in px Ex 200px or 20% - for taxonomy, category and archives pages.','wpestate').'</div>    
...
if( !function_exists('new_wpestate_advanced_search_settings') ):  
 function new_wpestate_advanced_search_settings(){
    ...
    <div class="option_row_explain">'.__('This applies for the search over header type. IMPORTANT! Enable Advanced Search Custom Fields - YES, for Type 5, Type 6, Type 8, Type 10 and Type 11. Type 7 & 9 look can be obtain with type 6 and 8 with float form set to yes. ca','wpestate').'</div>    
    ...
    <div class="option_row_explain">'.__('Disables or enables the display of advanced search ','wpestate').'</div>    
    ...
    print'<div class="estate_option_row">
    <div class="label_option_row">'.__('Show Advanced Search in Taxonomies, Categories or Archives ','wpestate').'</div>
    <div class="option_row_explain">'.__('Disables or enables the display of advanced search in taxonomies, categories and archives','wpestate').'</div>    
    ...
    print'<div class="estate_option_row">
    <div class="label_option_row">'.__('Advanced Search Background color Opacity','wpestate').'</div>
    <div class="option_row_explain">'.__('Values between 0 -invisible and 1 - fully visible','wpestate').'</div>    
...
function new_wpestate_ammenities_features(){
    ...
    <div class="option_row_explain">'.__('After adding a new feature,  make sure you select it to be part of the property submission form from Membership -> Property Submission Page. ','wpestate').'</div>   
...
function new_wpestate_property_links(){
    ...
    $links_to_rewrite = array(
        ...
        'category_agency'     =>  array(
                                         $rewrites[12],
                                        __('Agency Category Page','wpestate')
                                    ),
        ...
        'county_state_agency'     =>  array(
                                         $rewrites[16],
                                        __('Agency County/State Page','wpestate')
                                    ),
       
        'property_category_developer'     =>  array(
                                         $rewrites[17],
                                        __('Developer Cateogory Page','wpestate')
                                    ),
        'property_action_developer'     =>  array(
                                         $rewrites[18],
                                        __('Developer Action Category  Page','wpestate')
                                    ),
        'property_city_developer'     =>  array(
                                         $rewrites[19],
                                        __('Developer City Page','wpestate')
                                    ),
        'property_area_developer'     =>  array(
                                         $rewrites[20],
                                        __('Developer Area Page','wpestate')
                                    ),
        'property_county_state_developer'     =>  array(
                                         $rewrites[21],
                                        __('Developer County/State Page','wpestate')
                                    ),
    );
    
    $i=0;
      print'<div class="estate_option_row">'.__('You cannot use special characters like "&". After changing the url you may need to wait for a few minutes until WordPress changes all the urls. In case your new names do not update automatically, go to Settings - Permalinks and Save again the "Permalinks Settings" - option "Post name"','wpestate').'</div>';
...
if( !function_exists('new_wpestate_theme_slider') ):   
 function new_wpestate_theme_slider(){
    ...
    print'<div class="estate_option_row">
    <div class="label_option_row">'.__('Height in px (put 0 for full screen)','wpestate').'</div>
    <div class="option_row_explain">'.__('Height in px(put 0 for full screen, Default :580px)','wpestate').'</div>    
...
function new_wpestate_site_speed(){
    ...
    <div class="option_row_explain">'.__('3. Create a free account on Cloudflare (https://www.cloudflare.com/) and use this CDN.','wpestate').'</div>
